...
// Problem 1 - Who has/needs a small shirt?
let smallShirts = [];
smallShirts = runners.filter(function (runner) {
    return runner.shirt_size === "S"
});
console.log(smallShirts);

// Problem 2 - Who has/needs a medium shirt?

let mediumShirts = [];
mediumShirts = runners.filter(function (runner) {
    return runner.shirt_size === "M"
});
console.log(mediumShirts);

// Problem 3 - Who has/needs a extra large shirt?

let extraLargeShirts = [];
extraLargeShirts = runners.filter(function (runner) {
